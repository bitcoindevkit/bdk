...
| [`file_store`](./crates/file_store) | Persistence backend for storing BDK wallet data in a file. | ![File Store Crate Info](https://img.shields.io/crates/v/bdk_file_store.svg) ![File Store API Docs](https://img.shields.io/badge/docs.rs-bdk_file_store-green) |
| [`testenv`](./crates/testenv) | A library for running a test environment for bdk. | ![Testenv Crate Info](https://img.shields.io/crates/v/bdk_testenv.svg) ![Testenv API Docs](https://img.shields.io/badge/docs.rs-bdk_testenv-green) |
