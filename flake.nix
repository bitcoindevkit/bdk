{
  ...
  outputs = { self, nixpkgs, rust-overlay, flake-utils, pre-commit-hooks, electrs, ... }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        pkgs-esplora = electrs.packages.${system}.default;
        ...
        envVars = {
          ...
          ELECTRS_EXEC = "${pkgs-esplora}/bin/electrs";
