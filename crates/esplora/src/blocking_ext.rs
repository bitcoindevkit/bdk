...
impl EsploraExt for esplora_client::BlockingClient {
    fn full_scan<K: Ord + Clone, R: Into<FullScanRequest<K>>>(
        ...
        #[cfg(feature = "tracing-logs")]
        trace!(
            "Entering full_scan: stop_gap={} parallel_requests={}",
            stop_gap,
            parallel_requests
        );
    ...
    fn sync<I: 'static, R: Into<SyncRequest<I>>>(
        ...
        #[cfg(feature = "tracing-logs")]
        trace!("Entering sync: parallel_requests={}", parallel_requests);
...
fn fetch_txs_with_keychain_spks<I: Iterator<Item = Indexed<SpkWithExpectedTxids>>>(
    ...
    #[cfg(feature = "tracing-logs")]
    trace!(
        "fetch_txs_with_keychain_spks: start_time={} stop_gap={} parallel_requests={}",
        start_time,
        stop_gap,
        parallel_requests
    );
...
fn fetch_txs_with_spks<I: IntoIterator<Item = SpkWithExpectedTxids>>(
    ...
    #[cfg(feature = "tracing-logs")]
    trace!(
        "fetch_txs_with_spks: start_time={} parallel_requests={}",
        start_time,
        parallel_requests
    );
...
fn fetch_txs_with_txids<I: IntoIterator<Item = Txid>>(
    ...
    #[cfg(feature = "tracing-logs")]
    trace!(
        "fetch_txs_with_txids: start_time={} parallel_requests={}",
        start_time,
        parallel_requests
    );
...
fn fetch_txs_with_outpoints<I: IntoIterator<Item = OutPoint>>(
    ...
    #[cfg(feature = "tracing-logs")]
    trace!(
        "fetch_txs_with_outpoints: start_time={} parallel_requests={}",
        start_time,
        parallel_requests
    );
