...
#[allow(unused)]
const DESCRIPTOR_IDS: [&str; 7] = [
    "q32pjkqf", "nrj0e8r2", "2p07afla", "g3w4t0dz", "ngtdtwh6", "pvd7ct3d", "xnrgvgwv",
];

#[allow(unused)]
pub fn descriptor_ids(index: usize) -> [u8; 8] {
    DESCRIPTOR_IDS[index].as_bytes().try_into().unwrap()
}
