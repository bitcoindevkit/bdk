...
pub struct CombinedChangeSet<K, A> {
    ...
    pub indexed_tx_graph:
        crate::indexed_tx_graph::ChangeSet<A, crate::keychain_txout::ChangeSet<K>>,
...
#[cfg(feature = "miniscript")]
impl<K, A> From<crate::indexed_tx_graph::ChangeSet<A, crate::keychain_txout::ChangeSet<K>>>
    for CombinedChangeSet<K, A>
{
    fn from(
        indexed_tx_graph: crate::indexed_tx_graph::ChangeSet<
            A,
            crate::keychain_txout::ChangeSet<K>,
        >,
    ) -> Self {
        Self {
            indexed_tx_graph,
...
#[cfg(feature = "miniscript")]
impl<K, A> From<crate::keychain_txout::ChangeSet<K>> for CombinedChangeSet<K, A> {
