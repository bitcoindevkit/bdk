...
use bdk_chain::{
    indexed_tx_graph, keychain_txout, local_chain, tx_graph, Anchor, Append, DescriptorExt,
    DescriptorId,
};
...
mod test {
    ...
    use bdk_chain::CombinedChangeSet;
    use bdk_chain::{
        indexed_tx_graph, keychain_txout as keychain, tx_graph, BlockId, ConfirmationHeightAnchor,
