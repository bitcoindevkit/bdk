use jitash_bdk::bitcoin::{Address, Network};
use jitash_bdk::blockchain::{Blockchain, ElectrumBlockchain};
use jitash_bdk::database::MemoryDatabase;
use jitash_bdk::hwi::{types::HWIChain, HWIClient};
use jitash_bdk::miniscript::{Descriptor, DescriptorPublicKey};
use jitash_bdk::signer::SignerOrdering;
use jitash_bdk::wallet::{hardwaresigner::HWISigner, AddressIndex};
